...
# time mpiexec.mpich -n 4 python3.10 Programs/mpiPython_ColorToGray.py
...
def main(input_folder, output_folder):
    ...
    for img_file_indx in range(MPI.rank, len(image_files), MPI.size):
        image_file = image_files[img_file_indx]
