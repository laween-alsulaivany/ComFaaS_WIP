...
public class CoreOperations {
    ...
    public String edgeInputFolder    = ROOT.resolve("edge").resolve("Input").toString();
public String edgeOutputFolder   = ROOT.resolve("edge").resolve("Output").toString();
public String edgeProgramsFolder = ROOT.resolve("edge").resolve("Programs").toString();
public String edgeVenv           = ROOT.resolve(".edgeVenv").toString();
