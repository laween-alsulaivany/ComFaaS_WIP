    ...
    private void runInternal(String fileName, String inputFolder, String outputFolder, int numberOfProcesses)
        ...
        try {
            ...
            if (outputFolder != null && !outputFolder.isBlank()) {
                ...
                // Resolve the destination directory as outputFolder/tempDirName
                Path destDir = outputPath.resolve(tempDir.getFileName());
                // Ensure the destination base exists
                Files.createDirectories(outputPath);
                // Now copy the entire tempDir into destDir
